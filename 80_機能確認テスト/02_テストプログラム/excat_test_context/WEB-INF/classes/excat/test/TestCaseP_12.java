...
public class TestCaseP_12 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_12";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_12().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_12 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_12");
