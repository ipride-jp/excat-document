...
public class TestCaseP_4 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_4";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_4().setConfigAndRunCase("fire runtime exception in this case");
	}
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_4");
