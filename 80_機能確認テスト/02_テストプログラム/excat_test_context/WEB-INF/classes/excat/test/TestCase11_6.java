...
public class TestCase11_6 extends CommonCase {
	//change for every case
	private final static String caseNo = "11_6";
	...
	public static void main(String[] args) {
		...
		new TestCase11_6().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 11_6 
