...
public class TestCase13_5 extends CommonCase {
	//change for every case
	private final static String caseNo = "13_5";
	...
	public static void main(String[] args) {
		...
		new TestCase13_5().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 13_5 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 13_5");
