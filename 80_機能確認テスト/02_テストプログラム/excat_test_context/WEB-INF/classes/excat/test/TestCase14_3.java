...
public class TestCase14_3 extends CommonCase {
	//change for every case
	private final static String caseNo = "14_3";
	...
	public static void main(String[] args) {
		...
		new TestCase14_3().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 14_3 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 14_3");
