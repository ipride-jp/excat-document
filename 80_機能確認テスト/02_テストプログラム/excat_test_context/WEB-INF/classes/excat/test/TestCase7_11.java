...
public class TestCase7_11 extends CommonCase {
	//change for every case
	private final static String caseNo = "7_11";
	...
	public static void main(String[] args) {
		...
		new TestCase7_11().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 7_11 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 7_11");
