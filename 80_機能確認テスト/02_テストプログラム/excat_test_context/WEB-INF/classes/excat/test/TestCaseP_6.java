...
public class TestCaseP_6 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_6";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_6().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_6 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_6");
