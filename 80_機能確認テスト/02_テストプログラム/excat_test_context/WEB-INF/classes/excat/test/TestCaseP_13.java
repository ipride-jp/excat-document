...
public class TestCaseP_13 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_13";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_13().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_13 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_13");
