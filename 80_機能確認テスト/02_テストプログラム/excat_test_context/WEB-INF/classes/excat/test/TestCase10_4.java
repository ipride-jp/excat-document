...
public class TestCase10_4 extends CommonCase {
	//change for every case
	private final static String caseNo = "10_4";
	...
	public static void main(String[] args) {
		...
		new TestCase10_4().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 10_4 
