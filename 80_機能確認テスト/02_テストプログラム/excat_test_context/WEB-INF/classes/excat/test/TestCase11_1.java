...
public class TestCase11_1 extends CommonCase {
	//change for every case
	private final static String caseNo = "11_1";
	...
	public static void main(String[] args) {
		...
		new TestCase11_1().setConfigAndRunCase("fire Throwable in this case");
	}
	
	/**
	 * main process of Test Case 11_1 
