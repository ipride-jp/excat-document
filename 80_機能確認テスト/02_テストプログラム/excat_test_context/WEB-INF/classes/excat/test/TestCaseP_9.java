...
public class TestCaseP_9 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_9";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_9().setConfigAndRunCase("fire runtime exception in this case");
	}
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_9");
