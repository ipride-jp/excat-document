...
public class TestCaseP_14 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_14";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_14().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_14 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_14");
