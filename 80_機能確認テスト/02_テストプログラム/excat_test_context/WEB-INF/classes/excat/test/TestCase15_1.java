...
public class TestCase15_1 extends CommonCase {
	...
	public static void main(String[] args) {
		...
		new TestCase15_1().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 15_1 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 15_1");
