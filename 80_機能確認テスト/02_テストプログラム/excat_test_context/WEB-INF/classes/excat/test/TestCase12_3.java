...
public class TestCase12_3 extends CommonCase {
	//change for every case
	private final static String caseNo = "12_3";
	...
	public static void main(String[] args) {
		...
		new TestCase12_3().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 12_3 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 12_3");
