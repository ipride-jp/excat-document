...
public class TestCase14_4 extends CommonCase {
	...
	public static void main(String[] args) {
		...
		new TestCase14_4().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 14_4 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 14_4");
