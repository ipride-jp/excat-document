...
public class TestCase13_3 extends CommonCase {
	//change for every case
	private final static String caseNo = "13_3";
	...
	public static void main(String[] args) {
		...
		new TestCase13_3().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 13_3 
