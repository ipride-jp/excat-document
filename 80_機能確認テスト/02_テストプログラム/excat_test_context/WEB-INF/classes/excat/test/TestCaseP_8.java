...
public class TestCaseP_8 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_8";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_8().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_8 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_8");
