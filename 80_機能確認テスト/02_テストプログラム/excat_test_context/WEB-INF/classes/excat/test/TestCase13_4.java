...
public class TestCase13_4 extends CommonCase {
	//change for every case
	private final static String caseNo = "13_4";
	...
	public static void main(String[] args) {
		...
		new TestCase13_4().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 13_4 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 13_4");
