...
public class TestCase18_6 extends CommonCase {
	//change for every case
	public static String pub="publi";
	static String pack="packag";
	protected static String prot="protect";
	private final static String caseNo = "18_6";
	static ArrayList list = new ArrayList();

	public static void TestCase18_6(){
	...
	public static void main(String[] args) {
		...
		new TestCase18_6().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 18_6 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 18_6");
