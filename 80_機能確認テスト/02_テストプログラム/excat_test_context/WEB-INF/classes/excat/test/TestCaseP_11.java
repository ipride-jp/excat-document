...
public class TestCaseP_11 extends CommonCase {
	//change for every case
	private final static String caseNo = "P_11";
	...
	public static void main(String[] args) {
		...
		new TestCaseP_11().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case P_11 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case P_11");
