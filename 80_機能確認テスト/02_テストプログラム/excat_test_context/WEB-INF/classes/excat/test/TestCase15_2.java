...
public class TestCase15_2 extends CommonCase {
	...
	public static void main(String[] args) {
		...
		new TestCase15_2().setConfigAndRunCase("fire runtime exception in this case");
	}
	
	/**
	 * main process of Test Case 15_2 
	...
	public void runCase(Object caseMessage) throws Throwable{
		System.out.println("in case 15_2");
